...
// SVG Icons (same as in FooterSocialLinks.tsx)
const InstagramIcon = () => (
...
export function SocialLinks() {
  const socialLinks = [
    { icon: <InstagramIcon />, name: "اینستاگرام", url: "https://instagram.com/ARMIN_SOFT", color: "bg-gradient-to-br from-purple-600 to-pink-500" },
    { icon: <XIcon />, name: "ایکس", url: "https://x.com/@ARMIN_SOFT", color: "bg-gradient-to-br from-gray-800 to-black" },
    { icon: <WhatsAppIcon />, name: "واتساپ", url: "https://wa.me/989358983854", color: "bg-gradient-to-br from-green-400 to-green-600" },
    { icon: <TelegramIcon />, name: "تلگرام", url: "https://t.me/ARMIN_SOFT", color: "bg-gradient-to-br from-blue-400 to-blue-600" },
    { icon: <FacebookIcon />, name: "فیسبوک", url: "https://facebook.com/@ARMINSOFT0", color: "bg-gradient-to-br from-blue-500 to-blue-700" },
    { icon: <GithubIcon />, name: "گیت‌هاب", url: "https://github.com/ARMIN-SOFT", color: "bg-gradient-to-br from-gray-700 to-gray-900" },
    { icon: <YoutubeIcon />, name: "یوتیوب", url: "https://www.youtube.com/@ARMIN_SOFT", color: "bg-gradient-to-br from-red-500 to-red-700" },
    { icon: <YoutubeIcon />, name: "آپارات", url: "https://www.aparat.com/ARMIN_SOFT", color: "bg-gradient-to-br from-red-400 to-red-600" },
  ];
