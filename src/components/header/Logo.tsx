  ...
  return (
    ...
    >
      <div className="flex items-center gap-1">
        ...
        <div className="bg-gradient-to-l from-arminred-700 to-arminred-500 text-white p-2 md:p-2.5 rounded-lg shadow-md transition-all duration-300 group-hover:shadow-arminred-500/30 flex items-center justify-center">
