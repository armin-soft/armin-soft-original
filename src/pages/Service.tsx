...
const mainServices = [
  {
    ...
    description: "توسعه نرم‌افزارهای اختصاصی و قدرتمند برای تمامی پلتفرم‌ها از جمله رایانه و موبایل با پشتیبانی از سیستم‌عامل‌های مختلف.",
    details: [
      "نرم‌افزارهای رایانه (ویندوز، لینوکس، داس)",
      "نرم‌افزارهای موبایل (اندروید، آی‌او‌اس)",
  ...
  },
  {
    ...
    description: "طراحی و پیاده‌سازی ربات‌های هوشمند و سیستم‌های مبتنی بر هوش مصنوعی برای خودکارسازی فرآیندها.",
    details: [
      "ربات‌های تلگرام پیشرفته",
      "اسکریپت‌های هوش مصنوعی",
      "سیستم‌های یادگیری ماشین",
      "چت‌بات‌ها و دستیارهای مجازی",
    ],
  },
  {
    icon: <Server className="h-12 w-12 text-arminred-500" />,
    title: "توسعه وب‌سرویس‌ها",
    description: "طراحی و پیاده‌سازی وب‌سرویس‌های قدرتمند با پشتیبانی از دیتابیس و رابط‌های برنامه‌نویسی.",
    details: [
      "طراحی و مدیریت دیتابیس‌ها",
      "وب‌سرویس‌های نرم‌افزار و اپلیکیشن",
      "درگاه‌های رابط (API)",
